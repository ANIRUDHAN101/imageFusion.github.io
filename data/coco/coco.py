...
class COCOSegmentation(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.split == "train":
            _img , _target = self.transform_tr(sample)
        elif self.split == 'val':
    ...
    def _preprocess(self, ids, ids_file):
        ...
        for i in tbar:
            ...
            if (mask > 0).sum() > 1000:
                ...
                self.check_if_file_exists(img_id)
    ...
    def check_if_file_exists(self, index):
        coco = self.coco
...
if __name__ == "__main__":
    ...
    coco_val = COCOSegmentation(args, split='train', year='2017', base_dir='/home/anirudhan/project/image-fusion/data/coco')
